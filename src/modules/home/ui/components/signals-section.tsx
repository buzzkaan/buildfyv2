...
const signals = [
  { date: "2025.06.10", title: "Signal Field", note: "New interface paradigm for ambient computing environments." },
  { date: "2025.05.28", title: "Silent Agent", note: "Orchestration layer for autonomous design systems." },
  { date: "2025.05.15", title: "Noir Grid", note: "Typographic system for editorial interfaces." },
  { date: "2025.04.30", title: "Project Lattice", note: "Structural framework for adaptive layouts." },
  { date: "2025.04.12", title: "Echo Chamber", note: "Audio-visual synthesis in browser environments." },
]
